...
Knm::Ipv6Setting::EnumMethod::type Ipv6Dbus::methodStringToEnum(QString method)
{
    if (method.toLower() == QLatin1String(NM_SETTING_IP6_CONFIG_METHOD_AUTO))
        ...
        if (method.toLower() == QLatin1String(NM_SETTING_IP6_CONFIG_METHOD_DHCP))
            return Knm::Ipv6Setting::EnumMethod::Dhcp;
        else
            if (method.toLower() == QLatin1String(NM_SETTING_IP6_CONFIG_METHOD_LINK_LOCAL))
                return Knm::Ipv6Setting::EnumMethod::LinkLocal;
            else
                if (method.toLower() == QLatin1String(NM_SETTING_IP6_CONFIG_METHOD_MANUAL))
                    return Knm::Ipv6Setting::EnumMethod::Manual;
                else
                    if (method.toLower() == QLatin1String(NM_SETTING_IP6_CONFIG_METHOD_SHARED))
                        return Knm::Ipv6Setting::EnumMethod::Shared;
                    else
                        if (method.toLower() == QLatin1String(NM_SETTING_IP6_CONFIG_METHOD_IGNORE))
