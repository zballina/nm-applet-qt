...
class RemoteUnconfiguredInterfacePrivate;
/**
 * Interface to an UnconfiguredInterface supplied by a remote service
 */
class RemoteUnconfiguredInterface : public RemoteActivatable
{
        Q_OBJECT
