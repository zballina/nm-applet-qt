...
namespace Knm
{
    ...
    class VpnInterfaceConnectionHelpers
    {
        public:
            /**
             ...
             */
            static Knm::VpnInterfaceConnection *buildInterfaceConnection(
             ...
             * the corresponding Connection object.
             */
            static void syncInterfaceConnection(Knm::VpnInterfaceConnection *ic, Knm::Connection *c);
    };
} //Knm

#endif // KNM_EXTERNALS_VPNINTERFACECONNECTIONHELPERS_H
