...
namespace Knm
{
    ...
    class InterfaceConnectionHelpers
    {
        public:
            /**
             ...
             */
            static Knm::InterfaceConnection *buildInterfaceConnection(Knm::Connection *connection,
             ...
             * the corresponding Connection object.
             */
            static void syncInterfaceConnection(Knm::InterfaceConnection *ic, Knm::Connection *c);
    };

} //Knm

#endif // KNM_EXTERNALS_INTERFACECONNECTIONHELPERS_H
