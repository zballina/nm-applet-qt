...
static UiUtilsPrivate *s_UiUtilsPrivate = new UiUtilsPrivate();
...
#define SizeEnormous 128
#define SizeHuge 64
#define SizeLarge 48
#define SizeMedium 32
#define SizeSmallMedium 22
#define SizeSmall 16
...
QString UiUtils::operationModeToString(NetworkManager::WirelessDevice::OperationMode mode)
{
    ...
    switch (mode)
    {
        ...
        default
                :
            modeString = i18nc("INCORRECT MODE FIX ME");
    }
    return modeString;
}
...
QString UiUtils::convertBandToString(const ModemManager::ModemInterface::Band band)
{
    switch (band)
    {
        case ModemManager::ModemInterface::UnknownBand:
            return i18nc("Unknown cellular frequency band", "Unknown");
        case ModemManager::ModemInterface::AnyBand:
            return i18nc("Any cellular frequency band", "Any");
        case ModemManager::ModemInterface::Egsm:
            return i18nc("Cellular frequency band", "GSM/GPRS/EDGE 900 MHz");
        case ModemManager::ModemInterface::Dcs:
            return i18nc("Cellular frequency band", "GSM/GPRS/EDGE 1800 MHz");
        case ModemManager::ModemInterface::Pcs:
            return i18nc("Cellular frequency band", "GSM/GPRS/EDGE 1900 MHz");
        case ModemManager::ModemInterface::G850:
            return i18nc("Cellular frequency band", "GSM/GPRS/EDGE 850 MHz");
        case ModemManager::ModemInterface::U2100:
            return i18nc("Cellular frequency band", "WCDMA 2100 MHz (Class I)");
        case ModemManager::ModemInterface::U1800:
            return i18nc("Cellular frequency band", "WCDMA 3GPP 1800 MHz (Class III)");
        case ModemManager::ModemInterface::U17IV:
            return i18nc("Cellular frequency band", "WCDMA 3GPP AWS 1700/2100 MHz (Class IV)");
        case ModemManager::ModemInterface::U800:
            return i18nc("Cellular frequency band", "WCDMA 3GPP UMTS 800 MHz (Class VI)");
        case ModemManager::ModemInterface::U850:
            return i18nc("Cellular frequency band", "WCDMA 3GPP UMTS 850 MHz (Class V)");
        case ModemManager::ModemInterface::U900:
            return i18nc("Cellular frequency band", "WCDMA 3GPP UMTS 900 MHz (Class VIII)");
        case ModemManager::ModemInterface::U17IX:
            return i18nc("Cellular frequency band", "WCDMA 3GPP UMTS 1700 MHz (Class IX)");
        case ModemManager::ModemInterface::U19IX:
            return i18nc("Cellular frequency band", "WCDMA 3GPP UMTS 1900 MHz (Class II)");
    }
...
QString UiUtils::convertAllowedModeToString(const ModemManager::ModemInterface::AllowedMode mode)
{
    switch (mode)
    {
        case ModemManager::ModemInterface::AnyModeAllowed:
            return i18nc("Allowed Gsm modes (2G/3G/any)", "Any");
        case ModemManager::ModemInterface::Prefer2g:
            return i18nc("Allowed Gsm modes (2G/3G/any)", "Prefer 2G");
        case ModemManager::ModemInterface::Prefer3g:
            return i18nc("Allowed Gsm modes (2G/3G/any)", "Prefer 3G");
        case ModemManager::ModemInterface::UseOnly2g:
            return i18nc("Allowed Gsm modes (2G/3G/any)", "Only 2G");
        case ModemManager::ModemInterface::UseOnly3g:
            return i18nc("Allowed Gsm modes (2G/3G/any)", "Only 3G");
    }
...
NetworkManager::ModemDevice::Capability UiUtils::modemSubType(NetworkManager::ModemDevice::Capabilities modemCaps)
{
    if (modemCaps & NetworkManager::ModemDevice::Lte)
    {
        ...
        if (modemCaps & NetworkManager::ModemDevice::CdmaEvdo)
        {
            return NetworkManager::ModemDevice::CdmaEvdo;
        }
        else
            if (modemCaps & NetworkManager::ModemDevice::GsmUmts)
            {
                return NetworkManager::ModemDevice::GsmUmts;
            }
            else
                if (modemCaps & NetworkManager::ModemDevice::Pots)
                {
